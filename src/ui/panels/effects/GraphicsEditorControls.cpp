...
void GraphicsEditorPanel::buildEditControls()
{
 ...
 // Slider → spin box sync + live apply
 ...
 // Spin scrub → slider sync + live apply
 ...
 // ── Spacing values (tracking, leading, baseline shift) ──────
 {
 auto* rl = makeRow(10);
 ...
 // Wire arrow click → toggle children visibility
