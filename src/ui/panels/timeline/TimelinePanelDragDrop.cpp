...
void TimelinePanel::transitionDragMove(QDragMoveEvent* event)
{
...
void TimelinePanel::effectDragMove(QDragMoveEvent* event)
{
    QPointF pos = event->position();
...
void TimelinePanel::adjustmentDragMove(QDragMoveEvent* event)
{
...
void TimelinePanel::sequenceDragMove(QDragMoveEvent* event)
{
    m_effectDropTarget.reset();
    for (auto tw : m_trackWidgets) tw->clearEffectHighlight();
...
void TimelinePanel::mediaDragMove(QDragMoveEvent* event)
{
    m_effectDropTarget.reset();
    for (auto tw : m_trackWidgets) tw->clearEffectHighlight();
