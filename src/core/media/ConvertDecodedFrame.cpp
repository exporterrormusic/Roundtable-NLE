...
#include "media/FrameCache.h"     // CachedFrame + clearTransparentPixelRGB + chromaKeyInPlace
#include "media/MediaPool.h"      // PixelBufferPool
#include "media/VideoDecoder.h"   // DecodedFrame, VideoStreamInfo
