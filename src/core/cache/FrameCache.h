...
public:
    ...
    /// the data-side complement to CachePolicy::setPlayheadWindow — call
    /// either; CachePolicy forwards here.  Defaults (5 behind, 0 ahead)
...
private:
    ...
    // budget.  CachePolicy tunes this per GPU VRAM.  0 = uncapped.
