...
public:
    ...
    static constexpr uint32_t FORMAT_VERSION = 30;  // v30 = Premiere-parity masks: keyframeable mask scalars (feather/opacity/expansion), Mask Path keyframes, per-EFFECT masks
